...
const MY_EXPERIENCE: Array<Experience> = [
	...
	},
	{
		...
		description: '<ul><li>Collaborated with local, state, and federal law enforcement agencies as a Security Forces(SF) member in concurrent,reciprocal, and exclusive jurisdictions, ensuring the safety and security of individuals and properties within the designated areas for four years</li><li>Responded to and effectively managed security incidents, in-flight emergencies, and vehicular mishaps as a first responder, maintaining a rapid response time of under 5 minutes and mitigating risks to personnel and property</li><li>Provided area and convoy security during overseas assignments in Afghanistan, Kuwait, and the United Arab Emirates(UAE), contributing to successful battlefield operations and ensuring the safety of personnel and equipment in high-threat environments</li><li>Utilized advanced management software and state-of-the-art communications equipment to facilitate seamless operations between joint forces, resulting in efficient coordination and communication for mission success</li></ul><h4>Ali Al Salem Air Base, Kuwait : February 2012 - November 2012</h4><ul><li>Spearheaded 50 security patrols and access control measures, enhancing the base\'s security posture and readiness</li><li>Established strong partnerships with multinational forces and local authorities, strengthening base security and threat deterrence</li><li>Contributed to a 15% improvement in base security during the deployment through innovative security strategies and training</li><li>Provided vital assistance and maintained safety standards during emergencies and accidents, ensuring the well-being of personnel and resources</li></ul><h4>Bagram Air Field, Afghanistan : March 2012 - October 2012</h4><ul><li>Conducted and led over 20 security patrols and surveillance missions, ensuring the safety and well-being of over 500 personnel and assets</li><li>Collaborated with a diverse team and local military units to enforce security protocols and contribute to the overall mission success</li><li>Achieved a 25% reduction in security incidents during the deployment through proactive security measures and rapid response</li></ul><h4>Al Dhafra Air Base, UAE : May 2013 - December 2013</h4><ul><li>Led a team in conducting over 15 security patrols and surveillance missions, safeguarding the base and its personnel from potential threats</li><li>Collaborated seamlessly with international and interagency partners, facilitating a secure environment and mission success</li><li>Significantly contributed to a 10% reduction in security incidents during the deployment, enhancing overall safety</li><li>Demonstrated exceptional first responder capabilities by swiftly addressing security incidents, in-flight emergencies,and vehicular mishaps, ensuring the rapid protection of personnel and property</li></ul>',
		contract: ContractType.FullTime,
